...
import { Accessibility, Code2, Paintbrush, Search } from "lucide-react";
          ...
          <div className="relative z-10">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <span className="text-offwhite/40 text-sm font-light">
                  {feature.metricLabel}
                </span>
              </motion.div>
            </AnimatePresence>
              ...
              >
                ...
                >
                  ...
                  <div className="text-center px-4">
                    ...
                    <div className="text-offwhite/40 text-xs">
                      {feature.metricLabel}
                    </div>
                  </div>
                </div>
                ...
                {[0, 60, 120, 180, 240, 300].map((deg, i) => (
                  <motion.div
                    ...
                    animate={{
                      scale: [1, 1.5, 1],
                      opacity: [0.18 + i * 0.05, 0.4, 0.18 + i * 0.05],
                    }}
                    transition={{
                      duration: 2 + i * 0.3,
                      repeat: Infinity,
