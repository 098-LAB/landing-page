...
const customEase: [number, number, number, number] = [0.16, 1, 0.3, 1]; // Very smooth, heavy, Apple-like easing
    ...
    >
      ...
      >
        ...
        >
          ...
          <strong className="text-offwhite font-medium">humanas</strong>,{" "}
          <strong className="text-offwhite font-medium">acessíveis</strong> e{" "}
          <strong className="text-offwhite font-medium">estratégicas</strong>{" "}
          para pessoas, negócios e startups.
        </motion.p>
