    ...
    >
      ...
      >
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse, rgba(0,251,100,0.12) 0%, transparent 65%)",
            filter: "blur(40px)",
          }}
        />
      </motion.div>
      ...
      >
        ...
        >
          Tem um projeto, uma ideia ou um problema digital para resolver? A
          098lab está pronta para transformar isso em uma experiência que gera
          resultado real.
        </motion.p>
        ...
        >
          ...
          <MagneticButton href="#servicos">Ver serviços</MagneticButton>
        </motion.div>
        ...
        >
          {[
            ...
            <div key={s.value} className="text-center">
              ...
              <div className="text-offwhite/25 text-[11px] font-light">
                {s.label}
              </div>
            </div>
          ))}
