...
const items = [
  {
    ...
    description:
      "Não entregamos apenas design. Entregamos soluções pensadas para o negócio, o produto e os usuários ao mesmo tempo.",
  },
  {
    icon: UserCheck,
    title: "Design centrado no usuário",
    description:
      "Cada decisão é embasada em pesquisa, dados e empatia. O usuário está no centro de todo o processo.",
  },
  {
    icon: Accessibility,
    title: "Acessibilidade como prioridade",
    description:
      "Projetamos para todas as pessoas, desde o início. Acessibilidade não é ajuste final — é fundação.",
  },
  {
    icon: Merge,
    title: "Design + Desenvolvimento unidos",
    description:
      "Uma equipe que pensa em design e escreve código. Menos ruído, mais fidelidade, melhor resultado.",
  },
  {
    icon: Users2,
    title: "Processo colaborativo",
    description:
      "Trabalhamos com o cliente, não para o cliente. Cada etapa é transparente, iterativa e validada em conjunto.",
  },
  {
    icon: CheckCircle,
    title: "Compromisso com qualidade",
    description:
      "Cada entrega passa por revisão criteriosa. Não enviamos trabalho mediano. Nunca.",
  },
];
  ...
  return (
    <section ref={ref} className="py-24 md:py-32 relative overflow-hidden">
      ...
      <div
        ...
        style={{
          background: "radial-gradient(circle, #00FB64 0%, transparent 70%)",
        }}
      />
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            <span className="text-verde/80 text-xs font-mono tracking-[0.2em] uppercase">
              Diferenciais
            </span>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
            ...
            {items.slice(0, 4).map((item, i) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="text-offwhite font-semibold text-sm mb-2 tracking-tight">
                    {item.title}
                  </h3>
                  <p className="text-offwhite/40 text-xs leading-relaxed font-light">
                    {item.description}
                  </p>
                </motion.div>
              );
          ...
          <div className="flex flex-col gap-4">
            ...
            >
              <span className="text-verde font-semibold text-sm">
                Vamos conversar?
              </span>
