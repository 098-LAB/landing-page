...
import { AtSign, Globe, Link, Send } from "lucide-react";
        ...
        <div className="grid md:grid-cols-3 gap-12 mb-16">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-offwhite/40 text-sm leading-relaxed max-w-xs font-light">
              Laboratório de UX/UI Design e desenvolvimento digital. Criamos
              experiências que unem design, tecnologia e visão de negócio.
            </p>
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="mt-4">
                <span className="text-offwhite/20 text-xs font-mono">
                  São Paulo, Brasil
                </span>
              </div>
            </div>
            ...
            <div className="mt-6 p-4 rounded-xl border border-verde/20 bg-verde/5">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-verde text-xs font-medium">
                  Disponível para novos projetos
                </span>
              </div>
              <span className="text-offwhite/30 text-xs">
                Aberto para conversas e parcerias
              </span>
            </div>
          </div>
        </div>
