...
export default function References() {
  ...
  return (
    <section
      id="referencias"
      ref={ref}
      className="py-24 md:py-32 bg-concreto/10 relative overflow-hidden"
    >
      <div
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-[clamp(1.75rem,3.5vw,2.75rem)] font-bold leading-tight tracking-tight text-offwhite max-w-2xl">
            Repertório que <span className="text-verde">informa</span> e{" "}
            <span className="text-amarelo">inspira</span>.
          </h2>
          <p className="mt-4 text-offwhite/40 text-base font-light max-w-xl leading-relaxed">
            Referências que moldam nosso olhar sobre design, produto e
            experiência digital. Cada uma representa um padrão de qualidade que
            buscamos em cada entrega.
          </p>
        </motion.div>
