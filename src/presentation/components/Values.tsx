...
const accentMap: Record<string, string> = {
  ...
  amarelo:
    "border-amarelo/50 bg-amarelo/10 hover:border-amarelo/70 hover:bg-amarelo/15",
};
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            <span className="text-concreto text-xs font-mono tracking-[0.2em] uppercase">
              Pilares
            </span>
              ...
              >
                ...
                >
                  <Icon
                    size={20}
                    style={{
                      color: value.accent === "verde" ? "#009E40" : "#202020",
                    }}
                  />
                </div>
