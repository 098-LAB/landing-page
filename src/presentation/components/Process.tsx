...
const steps = [
  {
    ...
    title: "Descoberta",
    description:
      "Imersão no contexto. Entendemos o negócio, os usuários e as oportunidades reais antes de escrever qualquer linha.",
  },
  {
    icon: Map,
    title: "Estratégia",
    description:
      "Objetivos, princípios de design e roadmap definidos. Planejamos antes de executar — sempre.",
  },
  {
    icon: Pen,
    title: "Design",
    description:
      "Do wireframe ao protótipo de alta fidelidade. Iteramos rápido, alinhamos e refinamos até acertar.",
  },
  {
    icon: Terminal,
    title: "Desenvolvimento",
    description:
      "Código limpo, semântico e performático. Design implementado com fidelidade, responsividade e acessibilidade.",
  },
  {
    icon: FlaskConical,
    title: "Validação",
    description:
      "Testes com usuários reais, revisões técnicas e análise de resultados. Validamos antes de considerar pronto.",
  },
  {
    icon: RefreshCw,
    title: "Evolução",
    description:
      "Produto entregue não é projeto encerrado. Monitoramos, coletamos feedback e evoluímos com o negócio.",
  },
];
      ...
      >
        ...
        <div className="sticky top-0 h-screen overflow-hidden flex flex-col justify-center py-16">
          ...
          <div className="relative max-w-7xl mx-auto px-6 lg:px-8 w-full">
                    ...
                    >
                      ...
                      <span
                        className={`absolute -top-2 -right-2 w-5 h-5 rounded-full text-[9px] font-black flex items-center justify-center transition-colors duration-500 ${
                          isActive
                            ? "bg-grafite text-verde"
                            : "bg-concreto/60 text-offwhite/40"
                        }`}
                      >
                        {i + 1}
                      </span>
            ...
            <div
              ref={quoteRef}
              className="mt-14 pt-8 border-t border-concreto/20"
            >
              <motion.div
                initial={{ opacity: 0, y: 24 }}
              ...
              >
                <blockquote className="text-offwhite/40 text-xl md:text-2xl font-light italic max-w-2xl leading-relaxed">
                  ...
                  <motion.span
                    ...
                    animate={
                      quoteInView ? { color: "rgba(241,247,241,0.85)" } : {}
                    }
                ...
                >
                  <div className="w-10 h-10 rounded-full border border-verde/30 flex items-center justify-center bg-verde/5">
                    <span className="text-verde font-mono text-[11px] font-bold">
                      098
                    </span>
                  </div>
                  <span className="text-offwhite/25 font-mono text-[10px] tracking-widest">
                    lab
                  </span>
                </motion.div>
              </motion.div>
