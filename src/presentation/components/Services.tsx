...
const services = [
  {
    ...
    title: "UX Research",
    description:
      "Investigação do contexto, comportamentos e necessidades dos usuários para embasar decisões com dados reais.",
    tag: "Estratégia",
    accent: "#009E40",
  },
  {
    ...
    title: "UX Strategy",
    description:
      "Diretrizes de experiência alinhadas ao negócio, produto e usuários — antes de qualquer pixel.",
    tag: "Estratégia",
    accent: "#009E40",
  },
  {
    ...
    title: "UI Design",
    description:
      "Interfaces visuais coerentes, modernas e funcionais que comunicam com clareza e guiam com naturalidade.",
    tag: "Design",
    accent: "#3E5151",
  },
  {
    ...
    description:
      "Sistemas escaláveis com componentes documentados, tokens e guidelines para consistência total.",
    tag: "Design",
    accent: "#3E5151",
  },
  {
    ...
    title: "Prototipação",
    description:
      "Protótipos de alta fidelidade para validar hipóteses e testar fluxos antes do desenvolvimento.",
    tag: "Design",
    accent: "#3E5151",
  },
  {
    ...
    title: "Dev Front-end",
    description:
      "Código limpo e performático com React/Next.js. Design implementado com fidelidade obsessiva.",
    tag: "Dev",
    accent: "#009E40",
  },
  {
    ...
    description:
      "Páginas com foco em conversão, performance e identidade visual sólida. Do conceito ao deploy.",
    tag: "Dev",
    accent: "#009E40",
  },
  {
    ...
    description:
      "Desenvolvimento de produtos do zero: pesquisa, design e código com visão integrada de produto.",
    tag: "Produto",
    accent: "#009E40",
  },
  {
    ...
    description:
      "Auditoria e implementação de WCAG para garantir experiências inclusivas para todas as pessoas.",
    tag: "A11y",
    accent: "#3E5151",
  },
];
  ...
  return (
    ...
    >
      ...
      <div style={{ transform: "translateZ(20px)" }} className="relative z-10">
        ...
        <h3 className="text-grafite font-semibold text-sm mb-2.5 tracking-tight">
          {service.title}
        </h3>
        <p className="text-grafite/50 text-xs leading-relaxed font-light">
          {service.description}
        </p>
      </div>
    </motion.div>
...
export default function Services() {
  ...
  return (
    <section
      id="servicos"
      ref={ref}
      className="py-28 md:py-36 relative overflow-hidden bg-white"
    >
      {/* Parallax bg text */}
      <motion.div
        style={{ x: bgX }}
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          >
            Cada serviço é uma camada de valor. Trabalhamos de forma integrada
            ou pontual, conforme a necessidade do projeto.
          </motion.p>
        </div>
